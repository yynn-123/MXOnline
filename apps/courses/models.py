...
class Course(BaseModel):
    ...
    tag = models.CharField(verbose_name='课程标签',max_length=300,default="")
...
class Video(BaseModel):
    lensson = models.ForeignKey(Lesson,verbose_name='章节',on_delete=models.CASCADE)
...
class CourseResource(BaseModel):
    ...
    file = models.FileField(max_length=200, verbose_name='下载地址',upload_to='courses/%Y/%m')
    class Meta:
        verbose_name = '课程资源'
        verbose_name_plural = verbose_name
