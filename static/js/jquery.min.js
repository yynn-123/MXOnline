...
var Dml = {};
    ...
    Dml.regExp = {
        phone: /^1([38]\d|4[57]|5[0-35-9]|7[06-8]|8[89]|9[0-9])\d{8}$/,
        tel:/(^1([38]\d|4[57]|5[0-35-9]|7[06-8]|8[89]|9[0-9])\d{8}$)|(^((\d{7,8})|(\d{4}|\d{3})-(\d{7,8})|(\d{4}|\d{3})-(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1})|(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1}))$)/,
        email: /^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+(.[a-zA-Z0-9_-])+/,
        phMail: /(^1([38]\d|4[57]|5[0-35-9]|7[06-8]|8[89]|9[0-9])\d{8}$)|(^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+(.[a-zA-Z0-9_-])+)/,
        number: /^[0-9]*$/,
        float: /^\d+(\.\d+)?$/,
        zsNumber: /^(-?[1-9]\d*|0)$/,
        name: /^[\u4e00-\u9fa5a-zA-Z]+$/,
